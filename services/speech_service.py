...
class SpeechService:
    ...
    def recognized_handler(self, evt):
        ...
        if recognized_text:
            corrected_response = self.groq_service.check_grammar(recognized_text)
            self.recognized_text = corrected_response
    ...
    def stop_speech_recognition(self):
        ...
        try:
            ...
            display_chat_message(is_user=True, message_text=self.recognized_text)
    ...
    def synthesize_speech(self, text: str):
        ...
        result = self.speech_synthesizer.speak_text_async(cleaned_text).get()
